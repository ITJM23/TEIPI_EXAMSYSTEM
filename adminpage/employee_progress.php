...
<body class="bg-slate-50 min-h-screen text-slate-800">
  <div class="max-w-7xl mx-auto px-6 py-8">
    <header class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold">Employee Progress</h1>
        <p class="text-sm text-slate-500">View earned patches and certificates per employee</p>
      </div>
      <nav class="flex gap-2">
        <a href="adminindex.php" class="px-3 py-2 bg-slate-100 rounded">Dashboard</a>
        <a href="patches.php" class="px-3 py-2 bg-slate-100 rounded">Patches</a>
        <a href="certificates.php" class="px-3 py-2 bg-slate-100 rounded">Certificates</a>
      </nav>
    </header>
